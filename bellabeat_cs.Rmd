...
# Daily data
cat("dailyActivity_merged.csv", "=", sep = " ", file.info("dailyActivity_merged.csv")$size, "bytes", fill = TRUE)
cat("dailyCalories_merged.csv", "=", sep = " ", file.info("dailyCalories_merged.csv")$size, "bytes", fill = TRUE)
cat("dailyIntensities_merged.csv", "=", sep = " ", file.info("dailyIntensities_merged.csv")$size, "bytes", fill = TRUE)
cat("dailySteps_merged.csv", "=", sep = " ", file.info("dailySteps_merged.csv")$size, "bytes", fill = TRUE)
cat("sleepDay_merged.csv", "=", sep = " ", file.info("sleepDay_merged.csv")$size, "bytes", fill = TRUE)
cat("weightLogInfo_merged.csv", "=", sep = " ", file.info("weightLogInfo_merged.csv")$size, "bytes", fill = TRUE)
# Hourly data
cat("hourlyCalories_merged.csv", "=", sep = " ", file.info("hourlyCalories_merged.csv")$size, "bytes", fill = TRUE)
cat("hourlyIntensities_merged.csv", "=", sep = " ", file.info("hourlyIntensities_merged.csv")$size, "bytes", fill = TRUE)
cat("hourlySteps_merged.csv", "=", sep = " ", file.info("hourlySteps_merged.csv")$size, "bytes", fill = TRUE)
# Minute data
cat("minuteCaloriesNarrow_merged.csv", "=", sep = " ", file.info("minuteCaloriesNarrow_merged.csv")$size, "bytes", fill = TRUE)
cat("minuteIntensitiesNarrow_merged.csv", "=", sep = " ", file.info("minuteIntensitiesNarrow_merged.csv")$size, "bytes", fill = TRUE)
cat("minuteMETsNarrow_merged.csv", "=", sep = " ", file.info("minuteMETsNarrow_merged.csv")$size, "bytes", fill = TRUE)
cat("minuteSleep_merged.csv", "=", sep = " ", file.info("minuteSleep_merged.csv")$size, "bytes", fill = TRUE)
cat("minuteStepsNarrow_merged.csv", "=", sep = " ", file.info("minuteStepsNarrow_merged.csv")$size, "bytes", fill = TRUE)
```
...
### Active minutes: key health metric  
...
ggsave(file = "Moderate_activity_per_week.png")
```
...
ggsave(file = "Vigorous_activity_per_week.png") 
```
...
ggsave(file = "Moderate_vigorous_activity_per_week.png")
...
weekly_moderate_vigorous_p +
  ...
  guides(color = guide_legend(override.aes = list(size = 3)))
ggsave(file = "Moderate_vigorous_activity_per_week_154.png")
```
...
<center>
![Achievement Rate Groups](achievement_rate_groups.png)
</center>
...
Here is where we'll link to the shareholder presentation. My presentation 
includes:  
...
[Google Slides; requires onl;ine access](https://docs.google.com/presentation/d/1iUSOOkS2ltHPzK16cE9teWgOwfBGd1UAC1KaZ_ucew4/present?slide=id.p)
